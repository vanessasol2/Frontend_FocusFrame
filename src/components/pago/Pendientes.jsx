...
const Pendientes = () => {
  ...
  return (
    <div>
      <h2 className="mt-4 text-lg font-semibold text-gray-800">Pagos Pendientes</h2>
                ...
                <div className="bg-white px-6 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start gap-4">
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      <div className="overflow-hidden rounded-lg border border-gray-200 shadow-sm -ml-4">
                        <table className="min-w-full bg-white">
                          <tbody className="divide-y divide-gray-200">
                            <tr>
                              <td className="px-4 py-3 text-sm font-medium text-gray-500 bg-gray-100">Tipo</td>
                              <td className="px-4 py-3 text-gray-700">{pagoSeleccionado.tipo}</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 text-sm font-medium text-gray-500 bg-gray-100">Año</td>
                              <td className="px-4 py-3 text-gray-700">{pagoSeleccionado.año}</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 text-sm font-medium text-gray-500 bg-gray-100">Mes</td>
                              <td className="px-4 py-3 text-gray-700">{pagoSeleccionado.mes}</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 text-sm font-medium text-gray-500 bg-gray-100">Fecha</td>
                              <td className="px-4 py-3 text-gray-700">{pagoSeleccionado.fecha}</td>
                            </tr>
                            <tr>
                              <td className="px-4 py-3 text-sm font-medium text-gray-500 bg-gray-100">Valor</td>
                              <td className="px-4 py-3 text-gray-700">{pagoSeleccionado.valor}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
